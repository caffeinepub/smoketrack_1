...
export class Backend implements backendInterface {
    ...
    async addLog(arg0: string, arg1: bigint, arg2: number): Promise<SmokingLog> {
        if (this.processError) {
            try {
                const result = await this.actor.addLog(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteLog(arg0: bigint): Promise<SmokingLog> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteLog(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLogs(): Promise<Array<SmokingLog>> {
        if (this.processError) {
            try {
